    ...
    bindings: {
      ...
      underline: {
        ...
        handler: function (this: QuillKeyboardContext, range: QuillRange) {
          this.quill.format(
            "underline",
            !this.quill.getFormat(range).underline
          );
        },
      },
      strike: {
      ...
      orderedList: {
        ...
        handler: function (this: QuillKeyboardContext, range: QuillRange) {
          this.quill.format(
            "list",
            this.quill.getFormat(range).list === "ordered" ? false : "ordered"
          );
        },
      },
      ...
      bulletList: {
        ...
        handler: function (this: QuillKeyboardContext, range: QuillRange) {
          this.quill.format(
            "list",
            this.quill.getFormat(range).list === "bullet" ? false : "bullet"
          );
        },
      },
      ...
      blockquote: {
        ...
        handler: function (this: QuillKeyboardContext, range: QuillRange) {
          this.quill.format(
            "blockquote",
            !this.quill.getFormat(range).blockquote
          );
        },
      },
      ...
      header1: {
        ...
        handler: function (this: QuillKeyboardContext) {
          this.quill.format(
            "header",
            this.quill.getFormat().header === 1 ? false : 1
          );
        },
      },
      header2: {
        ...
        handler: function (this: QuillKeyboardContext) {
          this.quill.format(
            "header",
            this.quill.getFormat().header === 2 ? false : 2
          );
        },
      },
      header3: {
        ...
        handler: function (this: QuillKeyboardContext) {
          this.quill.format(
            "header",
            this.quill.getFormat().header === 3 ? false : 3
          );
        },
      },
      ...
      codeBlock: {
        ...
        handler: function (this: QuillKeyboardContext, range: QuillRange) {
          this.quill.format(
            "code-block",
            !this.quill.getFormat(range)["code-block"]
          );
        },
      },
    },
      ...
      {showShortcuts && (
        <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm">
          ...
          <div className="grid grid-cols-2 gap-2 text-gray-700">
            ...
            <div>
              <kbd className="px-2 py-1 bg-white border rounded">Ctrl+I</kbd>{" "}
              Italic
            </div>
            <div>
              <kbd className="px-2 py-1 bg-white border rounded">Ctrl+U</kbd>{" "}
              Underline
            </div>
            <div>
