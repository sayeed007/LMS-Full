  ...
  return (
    <div
      className={`bg-white border rounded-lg ${
        isInChapter ? "border-gray-200 ml-2" : "border-gray-300 shadow-sm"
      }`}
    >
      {/* Lesson Header */}
      <div
        ...
        <div className="flex items-center gap-3">
          ...
          <div
            className={`w-6 h-6 rounded-md flex items-center justify-center ${
              isInChapter ? "bg-blue-100" : "bg-green-100"
            }`}
          >
            <PlayCircle
              className={`w-4 h-4 ${
                isInChapter ? "text-blue-600" : "text-green-600"
              }`}
            />
          </div>
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-1">
              ...
              <LessonContentSummary lessonId={lesson._id} courseId={courseId} />
            </div>
          </div>
        </div>
        <div className="flex items-center gap-2">
              ...
              <div className="mb-3">
                ...
                <div className="space-y-1">
                  {lesson.resources?.map(
                    (resource: CourseResource, resourceIndex: number) => (
                      <div
                        key={resourceIndex}
              ...
              <div className="mb-3">
                ...
                {contentItems
                  ...
                  .map((assignmentItem, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-2 p-2 bg-white rounded border mb-2"
                    >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        {quizItem.data.quiz?.questions && (
                          <span className="text-xs text-gray-500">
                            {quizItem.data.quiz.questions.length} question
                            {quizItem.data.quiz.questions.length !== 1
                              ? "s"
                              : ""}
                          </span>
                        )}
