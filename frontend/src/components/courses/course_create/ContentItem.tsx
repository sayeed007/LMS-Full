...
export const ContentItem = ({
  ...
  const getContentIcon = (type: LessonContent["type"]) => {
    switch (type) {
      case "text":
        return { ContentIcon: "/icons/TextAa.png", ContentIconName: "TextAa" };
      case "block":
        return { ContentIcon: "/icons/Blocks.png", ContentIconName: "Blocks" };
      case "video":
        return { ContentIcon: "/icons/Video.png", ContentIconName: "Video" };
      case "audio":
        return { ContentIcon: "/icons/Audio.png", ContentIconName: "Audio" };
      case "document":
        return {
          ContentIcon: "/icons/Document.png",
          ContentIconName: "Document",
        };
      case "quiz":
        return { ContentIcon: "/icons/Quiz.png", ContentIconName: "Quiz" };
      case "assignment":
        return {
          ContentIcon: "/icons/Assignment.png",
          ContentIconName: "Assignment",
        };
      default:
        return {
          ContentIcon: "/icons/Document.png",
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <Button
            ...
            onClick={() =>
              router.push(
                `/courses/create/${courseId}/courseOutline/${lessonId}/content?type=${content.type}&contentId=${content._id}`
              )
            }
