...
const Footer = () => {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Certificates", href: "/certificates", requiresAuth: true },
    ...
    },
    {
      title: "Company",
      links: [
        { name: "About Us", href: "/about", requiresAuth: false },
  ...
  return (
    <footer className="bg-gradient-to-r from-gradient-start to-gradient-end text-gray-700 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Empowering learners and educators to create, manage, and deliver
