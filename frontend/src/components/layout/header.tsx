...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const matchingNavItem = visibleNavItems.find(
      (item) => item.href.split("/")[1] === currentPath
    );
    if (matchingNavItem) {
  ...
  return (
    <header className="bg-gradient-to-r from-gradient-start to-gradient-end text-gray-700 sticky top-0 z-50 shadow-sm">
