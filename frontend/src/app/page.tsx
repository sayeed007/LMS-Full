          ...
          <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                Empower your learning journey with our comprehensive platform. Create, manage, and deliver
                engaging courses to learners worldwide.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
                <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Rich Course Content</h3>
                  <p className="text-gray-600 text-sm">
                    Create and deliver engaging courses with videos, articles, quizzes, and assignments.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600 text-sm">
                    Monitor student progress with detailed analytics and comprehensive reporting.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Earn Certificates</h3>
                  <p className="text-gray-600 text-sm">
